...
class CustomSearchAlertView: UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    private var centerX: CGFloat! //view的中心
    ...
    func setup(indexPath: Int) {
        ...
        alertTableView.backgroundColor = UIColor(red:1.00, green:0.74, blue:0.62, alpha:1.0)
        alertTableView.layer.cornerRadius = 6.0
        alertTableView.separatorColor = .orange
